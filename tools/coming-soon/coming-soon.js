(() => {
  const tools = {
    bank: ["01", "开银行卡", "将整理开户条件、材料清单、费用、安全设置与账户维护注意事项。"],
    broker: ["02", "开美股券商账户", "将从监管、托管、费用、税务资料、入金路径和账户安全等维度提供选择框架。"],
    remittance: ["03", "跨境汇款", "将梳理合规汇款链路、必要信息、到账时间、中间行费用和常见退汇原因。"],
    funding: ["04", "券商出入金", "将整理不同券商的入金与出金流程、币种、费用、到账时间和信息核对清单。"],
  };
